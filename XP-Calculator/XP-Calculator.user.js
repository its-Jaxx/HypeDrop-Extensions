...
// @icon         https://raw.githubusercontent.com/its-Jaxx/HypeDrop-Extensions/refs/heads/main/XP-Calculator/XP-Calculator.png
// @grant        none
// @require      https://ajax.googleapis.com/ajax/libs/jquery/3.4.1/jquery.min.js
// @downloadURL  https://raw.githubusercontent.com/its-Jaxx/HypeDrop-Extensions/refs/heads/main/XP-Calculator/XP-Calculator.user.js
// @updateURL    https://raw.githubusercontent.com/its-Jaxx/HypeDrop-Extensions/refs/heads/main/XP-Calculator/XP-Calculator.user.js
// @license      WTFPL
// ==/UserScript==
/* global $ */
...
(function() {
    ...
    fetch("https://raw.githubusercontent.com/its-Jaxx/HypeDrop-Extensions/refs/heads/main/XP-Calculator/lvl_experience.json")
    ...
    setInterval(() => {
        ...
        const total_wagered = xp_current / 432.4324324324324;
        let xp_fornext = lvlarray[lvl].experience_points - xp_current;
        let wager_fornext = (lvlarray[lvl].experience_points / 432.4324324324324) - total_wagered;
        ...
        let wager_fordesired = xp_fordesired / 432.4324324324324;
        ...
        const case_cost = 0.16;

        const outcomes = [
            { net_loss: 0.10, probability: 0.599998 },
            { net_loss: -0.09, probability: 0.39825 },
            { net_loss: -1.14, probability: 0.0009 },
            { net_loss: -3.84, probability: 0.00045 },
            { net_loss: -12.84, probability: 0.0003 },
            { net_loss: -14.84, probability: 0.0001 },
            { net_loss: -99.84, probability: 0.000001 },
            { net_loss: -249.84, probability: 0.000001 }
        ];
